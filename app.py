...
def cabecalho():
    ...
    st.markdown(
        ...
        <div class="main-header" style="display:grid;grid-template-columns:380px 1fr 270px;align-items:center;gap:22px;">
            <div class="je-brand-box">
                <div class="je-emblem">
                    <div class="shape-yellow"></div>
                    <div class="shape-green"></div>
                    <div class="circle"><div class="stars">✦·✦<br/>·✦·</div></div>
                </div>
                <div class="je-brand-text">Justiça<br/>Eleitoral</div>
            </div>
...
def css_menu_institucional():
    st.markdown(
        ...
        .je-emblem .shape-yellow {
            position:absolute;
            inset: 8px 7px 7px 16px;
            background: #F4C400;
            clip-path: polygon(28% 0, 100% 0, 100% 100%, 0 100%, 0 78%, 70% 78%, 70% 21%, 28% 21%);
            border-radius: 2px;
        }

        .je-emblem .shape-green {
            position:absolute;
            inset: 30px 7px 7px 16px;
            background: #6D817C;
